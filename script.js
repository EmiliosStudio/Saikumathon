...
document.addEventListener("DOMContentLoaded", () => {
    ...
    async function renderPage(num) {
        ...
        const baseScale = (containerWidth / pageViewport.width) * 0.9; // 90% del ancho del contenedor
        
        // Multiplicar por devicePixelRatio para pantallas HD/Retina
        const pixelRatio = window.devicePixelRatio || 1;
        const scale = baseScale * pixelRatio;
        
        const viewport = page.getViewport({ scale });
        
        // Canvas interno en alta resolución
        pdfCanvas.width = viewport.width;
        pdfCanvas.height = viewport.height;
        
        // Tamaño CSS del canvas (visual)
